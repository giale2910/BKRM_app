...
// import {ImportTableRow} from "../../../../../components/TableRow/TableRow"
...
//   useEffect(() => {
//     console.log("anon",route.params?.newCart)
...
//               return(
//                 <ImportTableRow   key={row.uuid} row={row} handleChangeItemPrice={handleChangeItemPrice} handleChangeItemQuantity={handleChangeItemQuantity} handleDeleteItemCart={handleDeleteItemCart} handleUpdateBatches={handleUpdateBatches} handleDeleteItemCart={handleDeleteItemCart}/>
//               )
//           })}
//     </ScrollView>
